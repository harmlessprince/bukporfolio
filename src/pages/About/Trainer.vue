...
<template>
  <main class="text-primary">
    ...
    <Container>
      <div
          class="w-full flex max-sm:flex-col max-sm:gap-y-[2rem] items-center my-[5rem] max-sm:my-[2.7rem]">
        <div class="bookBrightImage w-[47.6rem] max-sm:w-full min-h-[62.8rem] max-sm:min-h-[34.7rem] rounded-[10px] relative mr-[5rem] max-sm:mr-0">
    ...
    <Container id="#coach">
      <div
        ...
        <div class="coachBrightImage w-[48.0rem] max-sm:w-full min-h-[43.3rem] max-sm:min-h-[27.8rem] sm:hidden">
          <img :src="Coach" class="w-full h-full rounded-[10px]" alt="bright"/>
        </div>
        <div class="w-[47.9rem] max-sm:w-full coachBrightText">
          <Heading title="Coach"/>
        ...
        <div class="w-[48.0rem] min-h-[43.3rem] max-sm:hidden coachBrightImage">
          <img :src="Coach" class="w-full h-full rounded-[10px]" alt="bright"/>
        </div>
      </div>
    </Container>
