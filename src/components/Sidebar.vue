  ...
  <nav :class='toggleSidebar.sideBar ? "sidebarContainer" : "sidebarContainerClose"'>
      ...
      <ul class=" font-xsm text-[1.8rem] flex-col items-center w-full space-y-[3rem]">
        ...
        <li class="">
          <RouterLink :to="{name: 'books'}"
                      ...
                      @click="toggleSidebar.hideSideBar()">Shop
          </RouterLink>
        </li>
        <li class="">
          <RouterLink
              :class='isRouteActive("blog", "") ? "bg-primaryColor p-[1rem] block" : "p-[1rem] block"'
              :to="{name: 'blog'}" @click="toggleSidebar.hideSideBar()">Blog
          </RouterLink>
        </li>
        <li class="">
          <RouterLink
    ...
    <div class="w-[20rem] mx-auto mt-[3rem]">
      <RouterLink :to="{ name: 'contact'}" class="border-0 mx-auto" activeClass="border-0"
                  @click="toggleSidebar.hideSideBar()">
        <button
